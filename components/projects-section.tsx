      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            A showcase of impactful solutions I've built across various
            industries, demonstrating technical expertise and business value
            delivery.
          </p>
        </div>
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="relative h-48 overflow-hidden">
                ...
                <Badge
                  variant="outline"
                  className="absolute top-3 left-3 text-xs bg-background/80 backdrop-blur-sm"
                >
                  {project.category}
                </Badge>
              </div>
